...
- La **tuerca** (8ª pieza, de reto): un bloque 3×3 con un agujero central sólido pero vacío. No se puede rellenar por dentro, pero la fila sí se limpia si el resto está completo.
...
- **Modelo del tablero**: una matriz `ROWS × COLS` donde cada celda guarda `0` (vacía), un índice de color (1–8) que identifica la pieza, o `-1` (`HOLE`, el agujero de la tuerca: sólido pero dibujado vacío).
